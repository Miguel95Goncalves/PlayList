...
public class Musica {
	...
	private int musica_id, musica_duracao, musica_album_id, musica_visualizacao, musica_autor_id;
	...
	public Musica(int musica_id, int musica_duracao, int musica_album_id, int musica_visualizacao, String musica_ano,
